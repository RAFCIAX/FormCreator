...
},{}],"Classes/FieldLabel.ts":[function(require,module,exports) {
"use strict";
...
},{}],"Classes/TextAreaField.ts":[function(require,module,exports) {
"use strict";
...
},{"./../Enums/FieldType":"Enums/FieldType.ts","./FieldLabel":"Classes/FieldLabel.ts"}],"Classes/SelectField.ts":[function(require,module,exports) {
"use strict";
...
},{"./../Enums/FieldType":"Enums/FieldType.ts","./FieldLabel":"Classes/FieldLabel.ts"}],"Classes/EmailField.ts":[function(require,module,exports) {
"use strict";
...
},{"./../Enums/FieldType":"Enums/FieldType.ts","./FieldLabel":"Classes/FieldLabel.ts"}],"Classes/DateField.ts":[function(require,module,exports) {
"use strict";
...
},{"./../Enums/FieldType":"Enums/FieldType.ts","./FieldLabel":"Classes/FieldLabel.ts"}],"Classes/CheckboxField.ts":[function(require,module,exports) {
"use strict";
...
},{"./../Enums/FieldType":"Enums/FieldType.ts","./FieldLabel":"Classes/FieldLabel.ts"}],"Classes/InputField.ts":[function(require,module,exports) {
"use strict";
...
},{"./FieldLabel":"Classes/FieldLabel.ts","./../Enums/FieldType":"Enums/FieldType.ts"}],"Classes/LocStorage.ts":[function(require,module,exports) {
"use strict";
...
},{}],"Classes/Router.ts":[function(require,module,exports) {
"use strict";
...
},{}],"Classes/Form.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Form.prototype.render = function (pole) {
    ...
    saveButton.addEventListener('click', function (ev) {
      ...
      if (Router_1.Router.getParam() != null) {
        _this.saveEditedDoc(_this, Router_1.Router.getParam());
      } else {
        _this.save(_this);
      }
    });
  ...
  Form.prototype.saveEditedDoc = function (data, key) {
    var storage = new LocStorage_1.LocStorage();
...
exports.Form = Form;
},{"./LocStorage":"Classes/LocStorage.ts","./Router":"Classes/Router.ts"}],"Classes/Deserializer.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Deserializer.Deserialize = function (documentObject) {
    var newFields = [];
    var objEntries = Object.entries(documentObject);
    var arrayOfObjects = objEntries[0][1];

    for (var _i = 0, arrayOfObjects_1 = arrayOfObjects; _i < arrayOfObjects_1.length; _i++) {
      var element = arrayOfObjects_1[_i];

      switch (element.Type) {
        case 'text':
          var instance1 = new InputField_1.InputField(element.Name, element.Label, element.Value);
        ...
        case 'checkbox':
          var instance2 = new CheckboxField_1.CheckboxField(element.Name, element.Label, element.Value);
          Object.assign(instance2, element);
          newFields.push(instance2);
          break;

        case 'date':
          var instance3 = new DateField_1.DateField(element.Name, element.Label, element.Value);
          Object.assign(instance3, element);
          newFields.push(instance3);
          break;

        case 'email':
          var instance4 = new EmailField_1.EmailField(element.Name, element.Label, element.Value);
          Object.assign(instance4, element);
          newFields.push(instance4);
          break;

        case 'radio':
          var instance5 = new SelectField_1.SelectField(element.Name, element.Label, [], element.Value);
          Object.assign(instance5, element);
          newFields.push(instance5);
          break;

        case 'textarea':
          var instance6 = new TextAreaField_1.TextAreaField(element.Name, element.Label, element.Value);
...
},{"./CheckboxField":"Classes/CheckboxField.ts","./DateField":"Classes/DateField.ts","./EmailField":"Classes/EmailField.ts","./SelectField":"Classes/SelectField.ts","./TextAreaField":"Classes/TextAreaField.ts","./InputField":"Classes/InputField.ts"}],"Classes/App.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function App() {
    ...
    fields.push(new CheckboxField_1.CheckboxField('checkbox-test2', 'Studiujesz dziennie?', 'test'));
    fields.push(new CheckboxField_1.CheckboxField('checkbox-test3', 'Studiujesz zaocznie?', 'test'));
  ...
  App.prototype.renderDocumentToEdit = function (documentObject) {
    var newFormEdit = new Form_1.Form(Deserializer_1.Deserializer.Deserialize(documentObject));
    console.log("asdasd");
...
exports.App = App;
},{"./TextAreaField":"Classes/TextAreaField.ts","./SelectField":"Classes/SelectField.ts","./EmailField":"Classes/EmailField.ts","./DateField":"Classes/DateField.ts","./CheckboxField":"Classes/CheckboxField.ts","./InputField":"Classes/InputField.ts","./Form":"Classes/Form.ts","./Deserializer":"Classes/Deserializer.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
exports.app.renderDocument(exports.app.TestForm);
},{"./Classes/App":"Classes/App.ts"}],"Classes/DocumentList.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function DocumentList() {
    var localStorage = new LocStorage_1.LocStorage();
  ...
  DocumentList.prototype.getDocument = function (id) {
    ...
    for (var _i = 0, _a = this.ListOfDocuments; _i < _a.length; _i++) {
      var key = _a[_i];
  ...
  DocumentList.prototype.getLength = function () {
    return this.getDocuments().length;
  };

  DocumentList.prototype.render = function (container) {
    var _this = this;
    ...
    var _loop_1 = function _loop_1(r) {
      ...
      for (var c = 0; c < 4; c++) {
        ...
        if (c == 0) {
          ...
          cell.appendChild(document.createTextNode(this_1.ListOfDocuments[r]));
        } else if (c == 2) {
          ...
          editbutton.addEventListener('click', function (ev) {
            ev.stopImmediatePropagation();
            ev.preventDefault();
            console.log(_this.ListOfDocuments[r]);
            var value = confirm("Are You sure you want to edit this document?");

            if (value == true) {
              window.location.href = "/edit-document.html?id=" + _this.ListOfDocuments[r];
            }
          });
          ...
          deletebutton.addEventListener('click', function (ev) {
            ...
            if (value == true) {
              _this.removeDocument(_this.ListOfDocuments[r]);
            }
          });
    ...
    for (var r = 0; r < this.ListOfDocuments.length; r++) {
      _loop_1(r);
    }
...
},{"./LocStorage":"Classes/LocStorage.ts"}],"edit-document.ts":[function(require,module,exports) {
"use strict";
...
var DocumentList_1 = require("./Classes/DocumentList");

var Router_1 = require("./Classes/Router");

var id = Router_1.Router.getParam();
console.log(id);
var listOfDocuments = new DocumentList_1.DocumentList();
var requestedDocument = listOfDocuments.getDocument(id);
index_1.app.renderDocumentToEdit(requestedDocument);
},{"./index":"index.ts","./Classes/DocumentList":"Classes/DocumentList.ts","./Classes/Router":"Classes/Router.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","edit-document.ts"], null)
//# sourceMappingURL=/edit-document.245c3fee.js.map